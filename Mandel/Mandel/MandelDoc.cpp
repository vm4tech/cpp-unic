...
CMandelDoc::CMandelDoc() noexcept
{
...
void CMandelDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMandelDoc::InitializeSearchContent()
{
...
void CMandelDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{

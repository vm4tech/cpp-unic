...
// FormDemoDoc.cpp : implementation of the CFormDemoDoc class
//
...
// CFormDemoDoc construction/destruction

CFormDemoDoc::CFormDemoDoc() noexcept
{
...
void CFormDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CFormDemoDoc::InitializeSearchContent()
{
...
void CFormDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{

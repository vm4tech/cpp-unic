...
Мои попытка сделать сериализацию завершились неудачей, и я создал новую ветку с багом [нерабочая сериализация](https://github.com/MaseDar/cpp-unic/tree/ToDoList-bugs), чтобы попытать счастье на помощь :smile:

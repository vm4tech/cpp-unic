...
// TabDemo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTabDemoApp, CWinApp)
...
// The one and only CTabDemoApp object

CTabDemoApp theApp;


// CTabDemoApp initialization

...
// MiniDraw.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMiniDrawApp

CMiniDrawApp theApp;


// Инициализация CMiniDrawApp
...
// Обработчики сообщений CMiniDrawApp

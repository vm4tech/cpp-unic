...
// MiniEdit.cpp : Defines the class behaviors for the application.
//
...
// CMiniEditApp construction

CMiniEditApp::CMiniEditApp() noexcept
{
	// TODO: replace application ID string below with unique ID string; recommended
	// format for string is CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("MiniEdit.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CMiniEditApp object

CMiniEditApp theApp;


// CMiniEditApp initialization
...
BOOL CMiniEditApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MiniEditTYPE,

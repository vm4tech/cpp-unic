...
// WinGreet.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CWinGreetApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CWinGreetApp::OnAppAbout)
...
// Создание CWinGreetApp

CWinGreetApp::CWinGreetApp() noexcept
{
	...
	SetAppID(_T("WinGreet.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CWinGreetApp

CWinGreetApp theApp;


// Инициализация CWinGreetApp
...
// Обработчики сообщений CWinGreetApp
